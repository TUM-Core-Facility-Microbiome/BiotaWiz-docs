...
:::note
This section describes how to run TACTIC using the CLI. If you don't want to use the terminal but a step-by-step graphical frontend please refer to [BiotaWiz](gui-quickstart)
:::
